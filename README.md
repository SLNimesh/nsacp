...
- `php artisan key:generate` -> to generate a key for the app
- configure the `.env` as needed. 

Refer [STEPS.md](STEPS.md) file for pre-requisites and chaging .env { setting up database }.
...
***From of awesome laravel community***
